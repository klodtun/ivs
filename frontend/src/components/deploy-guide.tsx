            ...
            {viewMode === "prompts" ? (
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        onClick={() => downloadText(prompt, `ivs-prompt-${activeTab}.md`)}
                        title={t("guide.download")}
                        className="flex items-center gap-1 px-2 py-0.5 text-[10px] rounded-md bg-gray-100 text-gray-600 hover:bg-brand-100 hover:text-brand-700 transition-all"
                      >
                        <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <div className="p-3">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-1">
                  <button
                    onClick={() => downloadText(templateContent, "ivs-app.md")}
                    title={t("guide.download")}
                    className="flex items-center gap-1 px-2.5 py-1 text-[10px] rounded-md bg-gray-100 text-gray-600 hover:bg-brand-100 hover:text-brand-700 transition-all"
                  >
                    <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                    </svg>
